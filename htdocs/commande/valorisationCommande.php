...
if ($object->id > 0) {
    ...
    $orders = array();
    $sql = "SELECT p.ref, det.total_ttc, det.qty, det.total_tva, det.price, s.reel, en.ref as entrepot FROM llx_commandedet as det";
    ...
    if ($res->num_rows) {
        while ($row = $res->fetch_assoc()) {
            ...
            array_push($orders, [$row['ref'], $row['price'], $row['qty'], $row['total_tva'], $row['total_ttc'], $row['reel'], $row['entrepot']]);
        }
    }
